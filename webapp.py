...
def populate_mongodb_backend():
    mb = MongoDBBackend(db_name='cork-example', hostname='mongodb://oskicloud:RedSolo1@troup.mongohq.com:10046/user_profiles', initialize=True)
...
aaa = Cork(backend=mb, email_sender='oskicloud@gmail.com', smtp_url='smtp://smtp.magnet.ie')
